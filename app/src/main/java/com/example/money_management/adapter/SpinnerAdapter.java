...
public class SpinnerAdapter extends BaseAdapter {
    ...
    // Có thể add bất cừ gì kế thừa Khoan vào list, tức ? là con Khoan
    // Nếu là <? super Integer> thì bất cứ gì là cha của Integer như Number, Object đều có thể được thêm vào
